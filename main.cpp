...
int main() {
	...
	while (true) {
		...
		cout << "1. Wprowadz liczbe w postaci binarnej" << endl;
		cout << "2. Dodaj wprowadzone liczby" << endl;
		cout << "3. Odejmij wprowadzone liczby" << endl;
		cout << "4. Pomnoz wprowadzone liczby" << endl;
		cout << "5. Podziel wprowadzone liczby" << endl;
		cout << "6. Porownaj wprowadzone liczby" << endl;
		cout << "7. Wypisz wprowadzone liczby w postaci binarnej" << endl;
		cout << "0. Zamknij" << endl;
		...
		if (opcja == 1) { //wprowadzenie w postaci binarnej
			lista.push_back(Bitowe());
			if (!lista.back().wczytajStringBinarny())
				lista.pop_back();
		}
		else if (opcja == 2) { //dodanie
		...
		else if (opcja == 7) { //wypisanie listy liczb binarnie
